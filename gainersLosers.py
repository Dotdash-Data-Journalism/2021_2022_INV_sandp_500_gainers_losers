...
def updateChart(dw_chart_id, dataSet, updateDate, dw_api_key):
    ...
    pngDwnldRes = requests.get(url=f"https://api.datawrapper.de/v3/charts/{dw_chart_id}/export/png?unit=px&mode=rgb&width=640&height=577&plain=false&scale=1&zoom=1&download=false&fullVector=false&ligatures=true&transparent=false&logo=auto&dark=false",
    headers=imgHeaders)
